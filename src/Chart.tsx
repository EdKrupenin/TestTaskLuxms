...
import { DIMENSIONS_EXTENDED, urls } from './constants';
...
const Chart: React.FC = () => {
    ...
    const calculateHeight = (value: number) => Math.max((value / maxInstanceTotal) * DIMENSIONS_EXTENDED.maxBarHeight, DIMENSIONS_EXTENDED.minBarHeight);
